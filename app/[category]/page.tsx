...
// DAFTAR KATEGORI YANG NON-AKTIF / SOLD OUT
const UNAVAILABLE_CATEGORIES = ["jeep", "atv", "rafting"];
...
export default async function CategoryPage(props: PageProps) {
  ...
  return (
    <main className="bg-[#E5E7E1] min-h-screen text-[#2F3E2E] font-sans overflow-x-hidden flex flex-col">
      
      {/* 2. NOTIFIKASI BAR (Tampilan Baru Sesuai Desain) */}
      {isUnavailable && (
      ...
      {/* 3. KONTEN UTAMA 
          Jika isUnavailable: grayscale + pointer-events-none
      */}
